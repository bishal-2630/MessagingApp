...
from . import views 
from .views import RegisterView, LoginView, ProfileView, DeleteAccountView, UserViewSet, UserSearchView, RegisterFCMTokenView, ForgotPasswordView, VerifyOTPView, ResetPasswordView, VerifyEmailView, ResendVerificationView, GoogleLoginView
